...
declare type RESOURCE_ENERGY = "energy"; declare const RESOURCE_ENERGY: RESOURCE_ENERGY;
declare type RESOURCE_POWER = "power"; declare const RESOURCE_POWER: RESOURCE_POWER;
declare type RESOURCE_UTRIUM = "U"; declare const RESOURCE_UTRIUM: RESOURCE_UTRIUM;
declare type RESOURCE_LEMERGIUM = "L"; declare const RESOURCE_LEMERGIUM: RESOURCE_LEMERGIUM;
declare type RESOURCE_KEANIUM = "K"; declare const RESOURCE_KEANIUM: RESOURCE_KEANIUM;
declare type RESOURCE_GHODIUM = "G"; declare const RESOURCE_GHODIUM: RESOURCE_GHODIUM;
declare type RESOURCE_ZYNTHIUM = "Z"; declare const RESOURCE_ZYNTHIUM: RESOURCE_ZYNTHIUM;
declare type RESOURCE_OXYGEN = "O"; declare const RESOURCE_OXYGEN: RESOURCE_OXYGEN;
declare type RESOURCE_HYDROGEN = "H"; declare const RESOURCE_HYDROGEN: RESOURCE_HYDROGEN;
declare type RESOURCE_CATALYST = "X"; declare const RESOURCE_CATALYST: RESOURCE_CATALYST;
declare type RESOURCE_HYDROXIDE = "OH"; declare const RESOURCE_HYDROXIDE: RESOURCE_HYDROXIDE;
declare type RESOURCE_ZYNTHIUM_KEANITE = "ZK"; declare const RESOURCE_ZYNTHIUM_KEANITE: RESOURCE_ZYNTHIUM_KEANITE;
declare type RESOURCE_UTRIUM_LEMERGITE = "UL"; declare const RESOURCE_UTRIUM_LEMERGITE: RESOURCE_UTRIUM_LEMERGITE;
declare type RESOURCE_UTRIUM_HYDRIDE = "UH"; declare const RESOURCE_UTRIUM_HYDRIDE: RESOURCE_UTRIUM_HYDRIDE;
declare type RESOURCE_UTRIUM_OXIDE = "UO"; declare const RESOURCE_UTRIUM_OXIDE: RESOURCE_UTRIUM_OXIDE;
declare type RESOURCE_KEANIUM_HYDRIDE = "KH"; declare const RESOURCE_KEANIUM_HYDRIDE: RESOURCE_KEANIUM_HYDRIDE;
declare type RESOURCE_KEANIUM_OXIDE = "KO"; declare const RESOURCE_KEANIUM_OXIDE: RESOURCE_KEANIUM_OXIDE;
declare type RESOURCE_LEMERGIUM_HYDRIDE = "LH"; declare const RESOURCE_LEMERGIUM_HYDRIDE: RESOURCE_LEMERGIUM_HYDRIDE;
declare type RESOURCE_LEMERGIUM_OXIDE = "LO"; declare const RESOURCE_LEMERGIUM_OXIDE: RESOURCE_LEMERGIUM_OXIDE;
declare type RESOURCE_ZYNTHIUM_HYDRIDE = "ZH"; declare const RESOURCE_ZYNTHIUM_HYDRIDE: RESOURCE_ZYNTHIUM_HYDRIDE;
declare type RESOURCE_ZYNTHIUM_OXIDE = "ZO"; declare const RESOURCE_ZYNTHIUM_OXIDE: RESOURCE_ZYNTHIUM_OXIDE;
declare type RESOURCE_GHODIUM_HYDRIDE = "GH"; declare const RESOURCE_GHODIUM_HYDRIDE: RESOURCE_GHODIUM_HYDRIDE;
declare type RESOURCE_GHODIUM_OXIDE = "GO"; declare const RESOURCE_GHODIUM_OXIDE: RESOURCE_GHODIUM_OXIDE;
declare type RESOURCE_UTRIUM_ACID = "UH2O"; declare const RESOURCE_UTRIUM_ACID: RESOURCE_UTRIUM_ACID;
declare type RESOURCE_UTRIUM_ALKALIDE = "UHO2"; declare const RESOURCE_UTRIUM_ALKALIDE: RESOURCE_UTRIUM_ALKALIDE;
declare type RESOURCE_KEANIUM_ACID = "KH2O"; declare const RESOURCE_KEANIUM_ACID: RESOURCE_KEANIUM_ACID;
declare type RESOURCE_KEANIUM_ALKALIDE = "KHO2"; declare const RESOURCE_KEANIUM_ALKALIDE: RESOURCE_KEANIUM_ALKALIDE;
declare type RESOURCE_LEMERGIUM_ACID = "LH2O"; declare const RESOURCE_LEMERGIUM_ACID: RESOURCE_LEMERGIUM_ACID;
declare type RESOURCE_LEMERGIUM_ALKALIDE = "LHO2"; declare const RESOURCE_LEMERGIUM_ALKALIDE: RESOURCE_LEMERGIUM_ALKALIDE;
declare type RESOURCE_ZYNTHIUM_ACID = "ZH2O"; declare const RESOURCE_ZYNTHIUM_ACID: RESOURCE_ZYNTHIUM_ACID;
declare type RESOURCE_ZYNTHIUM_ALKALIDE = "ZHO2"; declare const RESOURCE_ZYNTHIUM_ALKALIDE: RESOURCE_ZYNTHIUM_ALKALIDE;
declare type RESOURCE_GHODIUM_ACID = "GH2O"; declare const RESOURCE_GHODIUM_ACID: RESOURCE_GHODIUM_ACID;
declare type RESOURCE_GHODIUM_ALKALIDE = "GHO2"; declare const RESOURCE_GHODIUM_ALKALIDE: RESOURCE_GHODIUM_ALKALIDE;
declare type RESOURCE_CATALYZED_UTRIUM_ACID = "XUH2O"; declare const RESOURCE_CATALYZED_UTRIUM_ACID: RESOURCE_CATALYZED_UTRIUM_ACID;
declare type RESOURCE_CATALYZED_UTRIUM_ALKALIDE = "XUHO2"; declare const RESOURCE_CATALYZED_UTRIUM_ALKALIDE: RESOURCE_CATALYZED_UTRIUM_ALKALIDE;
declare type RESOURCE_CATALYZED_KEANIUM_ACID = "XKH2O"; declare const RESOURCE_CATALYZED_KEANIUM_ACID: RESOURCE_CATALYZED_KEANIUM_ACID;
declare type RESOURCE_CATALYZED_KEANIUM_ALKALIDE = "XKHO2"; declare const RESOURCE_CATALYZED_KEANIUM_ALKALIDE: RESOURCE_CATALYZED_KEANIUM_ALKALIDE;
declare type RESOURCE_CATALYZED_LEMERGIUM_ACID = "XLH2O"; declare const RESOURCE_CATALYZED_LEMERGIUM_ACID: RESOURCE_CATALYZED_LEMERGIUM_ACID;
declare type RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE = "XLHO2"; declare const RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE: RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE;
declare type RESOURCE_CATALYZED_ZYNTHIUM_ACID = "XZH2O"; declare const RESOURCE_CATALYZED_ZYNTHIUM_ACID: RESOURCE_CATALYZED_ZYNTHIUM_ACID;
declare type RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE = "ZXHO2"; declare const RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE: RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE;
declare type RESOURCE_CATALYZED_GHODIUM_ACID = "XGH2O"; declare const RESOURCE_CATALYZED_GHODIUM_ACID: RESOURCE_CATALYZED_GHODIUM_ACID;
declare type RESOURCE_CATALYZED_GHODIUM_ALKALIDE = "XGHO2"; declare const RESOURCE_CATALYZED_GHODIUM_ALKALIDE: RESOURCE_CATALYZED_GHODIUM_ALKALIDE;
declare type RESOURCES_ALL = (
    | RESOURCE_ENERGY
    | RESOURCE_POWER
    | RESOURCE_UTRIUM
    | RESOURCE_LEMERGIUM
