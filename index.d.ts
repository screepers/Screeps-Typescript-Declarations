...
interface CPU {
    ...
    limit: number;
    /**
     * An amount of available CPU time at the current game tick. It can be
     * higher than `Game.cpu.limit`.
     *
     * @type {number}
     * @memberof CPU
     */
...
interface FindPathOpts {
     ...
     * creeps around or in some other cases.
     *
     ...
     * spawns, extensions) as walkable. Use this flag when you need to move
     * through a territory blocked by hostile structures.
     *
     * If a creep with an `ATTACK` body part steps on such a square,
     * it automatically attacks the structure.
     *
     * The default value is `false`.
     */
    ...
    /**
     * You can use this callback to modify a CostMatrix for any room during the
     * search.
     *
     * The callback accepts two arguments, `roomName` and `costMatrix`. Use the
     * `costMatrix` instance to make changes to the positions costs. If you
     * return a new matrix from this callback, it will be used instead of the
     * built-in cached one.
     *
    ...
    /**
     * An array of the room's objects or `RoomPosition` objects which should be
     * treated as walkable tiles during the search.
     *
     * This option cannot be used when the new PathFinder is enabled (use
     * `costCallback` option instead).
     */
    ignore?: any[] | RoomPosition[];

    /**
     * An array of the room's objects or `RoomPosition` objects which should be
     * treated as obstacles during the search.
     *
     * This option cannot be used when the new PathFinder is enabled (use
     * `costCallback` option instead).
     */
     ...
     *
     * You can limit CPU time used for the search based on ratio 1 op ~ 0.001
     * CPU.
     *
     ...
     *
     * The default is to path to the tile that the target is on (0).
     */
    range?: number;
}
...
interface MoveToOpts extends FindPathOpts {
     ...
     * It allows to save CPU time, but can result in a slightly slower creep
     * reaction behavior. The path is stored into the creep's memory to the
     * `_move` property.
     *
     * The `reusePath` value defines the amount of ticks which the path should
     * be reused for. The default value is `5`. Increase the amount to save more
     * CPU, decrease to make the movement more consistent.
     *
    ...
    /**
     * If reusePath is enabled and this option is set to true, the path will be
     * stored in memory in the short serialized form using `Room.serializePath`.
     *
     ...
     * if there is no memorized path to reuse. This can significantly save CPU
     * time in some cases.
     *
     * The default value is `false`.
     */
...
interface Game {
     ...
     *
     * Note that we name this `GameMap` to prevent conflicts with the reserved
     * keyword `Map`.
     */
    map: GameMap;
    /**
    ...
    /**
     * Get an object with the specified unique ID. It may be a game object of
     * any type.
     *
...
interface Creep extends RoomObject {
    ...
    /**
     * An array describing the creep’s body. Each element contains the following
     * properties:
     *
     * - type: string
     * - body part constant
    ...
    hitsMax: number;
    /**
     * A unique object identifier. You can use Game.getObjectById method to
     * retrieve an object instance by its id.
     */
    id: string;
    /**
     * A shorthand to Memory.creeps[creep.name]. You can use it for quick access
     * the creep’s specific memory data object.
     */
    memory: any;
    /**
    ...
    owner: Owner;
    /**
     * The link to the Room object. Always defined because creeps give
     * visibility into the room they're in.
     */
    room: Room;
    /**
     ...
     *
     * @returns Result Code: OK, ERR_NOT_OWNER, ERR_BUSY, ERR_INVALID_TARGET,
...
interface Room {
     ...
     * @param secondaryColor The secondary color of a new flag. Should be one of the COLOR_* constants. The default value is equal to color.
     */
    createFlag(pos: RoomPosition | { pos: RoomPosition }, name?: string, color?: number, secondaryColor?: number): number | string;
    /**
...
interface RoomPosition {
     ...
     * @param secondaryColor The secondary color of a new flag. Should be one of the COLOR_* constants. The default value is equal to color.
     */
    createFlag(name?: string, color?: number, secondaryColor?: number): number | string;
    /**
